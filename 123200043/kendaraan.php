  ...
  <table border="1" class="text-center" align="center" cellpadding="3" cellspacing="5">
   ...
   <?php
        ...
        function convert($value)
            ...
            $query = mysqli_query($conn, "SELECT * from inventaris WHERE kategori='Kendaraan'");
...
<tr>
    ...
    <h1 style="clear:both;margin-left:600px;margin-top:8px;font-size:1.2rem;"><?php echo "Total Inventaris Kendaraan = " . convert($total_harga); ?></h1>
</tr>
   </center>
